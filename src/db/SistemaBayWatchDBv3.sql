...
CREATE TABLE `usuarios` (
  ...
  CONSTRAINT `chk_usuario_tipo` CHECK (`personal_id` is not null and `huesped_id` is null or `personal_id` is null and `huesped_id` is not null)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Gestionar reservas', 'Permiso para crear, modificar y cancelar reservas'),
(2, 'gestion_usuarios', 'Permite crear, leer, actualizar y eliminar usuarios.');
